...
# Set root directory for advn
advn_root = "/postproc_results/processed_avg_rewards/organized_by_alg_env/advn_norm_mean"

# Load best hyperparameters
best_hyper_path = os.path.join(advn_root, "best_hyperparams_advn_auc.csv")
...
for env_folder in glob.glob(os.path.join(advn_root, "*")):
        ...
        for params, rewards in rewards_by_config:
            ...
            if N == 4:
                ...
                match = (
                    ...
                    params["criticlr"] == str(best_criticlr)
                )
            elif N == 0:
                match = (
                    params["actorlr"] == str(best_actorlr) and
...
output_path = os.path.join(advn_root, "multi_N_auc_advn_1.csv")
