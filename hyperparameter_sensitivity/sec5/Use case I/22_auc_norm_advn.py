...
lambda_ac_root = "/postproc_results/processed_avg_rewards/organized_by_alg_env/advn_norm_mean"
multi_auc_path = os.path.join(lambda_ac_root, "multi_N_auc_advn_1.csv")
...
output_path = os.path.join(lambda_ac_root, "normalized_multi_N_auc_advn_1.csv")
